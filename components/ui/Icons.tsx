...
export function IconBuilding() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M8 12h.01M16 12h.01M8 16h.01M16 16h.01M12 12h.01M12 16h.01" />
    </svg>
  );
}
...
export const MODULE_ICONS: Record<ModuleType, () => React.ReactElement> = {
  smart: IconZap,
  ...
  sentiment: IconMessageSquare,
  funding: IconDollarSign,
};
