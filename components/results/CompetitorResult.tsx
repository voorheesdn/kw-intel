...
export function CompetitorResult({ data }: { data: CompetitorData }) {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div><SectionLabel>Strengths</SectionLabel><Card><TagList items={data.strengths || []} variant="teal" /></Card></div>
